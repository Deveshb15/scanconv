/**
 * Server-side perspective transformation to flatten a quadrilateral to a rectangle
 ...
 * Takes RGBA buffer with source corners and produces a rectangular output
 */
